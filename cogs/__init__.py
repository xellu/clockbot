...
#add cogs here ⬇️
try:
    from . import (status, clockapi, whitelist, chatlink, moderation)
    COGS = [status.Status, chatlink.ChatLink, clockapi.ClockAPI, whitelist.Whitelist, moderation.Moderation] 
